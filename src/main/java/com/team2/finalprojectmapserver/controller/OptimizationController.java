...
public class OptimizationController {
    ...
    public ResponseEntity<List<OptimizationResponse>> optimize(@RequestBody List<OptimizationRequest> requestList) {
    ...
    public ResponseEntity<OptimizationResponse> getOptimumPath(@RequestBody OptimizationRequest request) {
